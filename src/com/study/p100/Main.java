...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 100 题 ======");
        System.out.println("题目：Callable 和 Future");
        System.out.println("说明：使用 Callable<Integer> 计算 1 到 100 的和。");
        System.out.println();
        run();
    }
