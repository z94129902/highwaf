...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 38 题 ======");
        System.out.println("题目：LinkedHashSet 保持插入顺序");
        System.out.println("说明：使用 HashSet 和 LinkedHashSet 分别保存相同数据。");
        System.out.println();
        run();
    }
