...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 54 题 ======");
        System.out.println("题目：Iterable 支持增强 for");
        System.out.println("说明：定义一个班级类 ClassRoom，内部保存学生列表。");
        System.out.println();
        run();
    }
