...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 48 题 ======");
        System.out.println("题目：HashMap 简易购物车");
        System.out.println("说明：使用 HashMap<String, Integer> 保存商品名称和购买数量。");
        System.out.println();
        run();
    }
