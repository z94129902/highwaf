...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 1 题 ======");
        System.out.println("题目：数组最大值和最小值");
        System.out.println("说明：定义一个 int[] 数组，存放 10 个整数。通过循环找出最大值、最小值、总和和平均值。");
        System.out.println();
        run();
    }
