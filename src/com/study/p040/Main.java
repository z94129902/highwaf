...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 40 题 ======");
        System.out.println("题目：HashMap 统计单词次数");
        System.out.println("说明：输入一段英文句子，统计每个单词出现次数。");
        System.out.println();
        run();
    }
