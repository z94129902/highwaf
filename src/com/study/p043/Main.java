...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 43 题 ======");
        System.out.println("题目：HashMap 嵌套集合");
        System.out.println("说明：使用 HashMap<String, ArrayList<String>> 保存班级和学生名单。");
        System.out.println();
        run();
    }
