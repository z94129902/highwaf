...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 95 题 ======");
        System.out.println("题目：继承 Thread 创建线程");
        System.out.println("说明：创建一个类继承 Thread。");
        System.out.println();
        run();
    }
