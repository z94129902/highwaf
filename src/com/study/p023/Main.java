...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 23 题 ======");
        System.out.println("题目：ArrayList 转数组");
        System.out.println("说明：创建 ArrayList<String>，将集合转换为数组。");
        System.out.println();
        run();
    }
