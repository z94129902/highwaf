...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 19 题 ======");
        System.out.println("题目：ArrayList 查找指定元素");
        System.out.println("说明：使用 ArrayList<String> 保存城市名称。");
        System.out.println();
        run();
    }
