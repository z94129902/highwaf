...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 24 题 ======");
        System.out.println("题目：数组转 ArrayList");
        System.out.println("说明：定义一个字符串数组，将其转换成 ArrayList<String>。");
        System.out.println();
        run();
    }
