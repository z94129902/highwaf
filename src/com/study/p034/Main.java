...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 34 题 ======");
        System.out.println("题目：HashSet 存储自定义对象");
        System.out.println("说明：定义 Student 类，包含姓名和年龄。使用 HashSet<Student> 保存学生。");
        System.out.println();
        run();
    }
