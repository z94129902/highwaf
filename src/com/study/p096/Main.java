...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 96 题 ======");
        System.out.println("题目：实现 Runnable 创建线程");
        System.out.println("说明：创建一个类实现 Runnable。");
        System.out.println();
        run();
    }
