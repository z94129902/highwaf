...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 39 题 ======");
        System.out.println("题目：HashMap 保存电话簿");
        System.out.println("说明：使用 HashMap<String, String> 保存姓名和手机号。");
        System.out.println();
        run();
    }
