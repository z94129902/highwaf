...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 44 题 ======");
        System.out.println("题目：HashMap 判断 key 和 value");
        System.out.println("说明：创建 HashMap<String, String> 保存国家和首都。");
        System.out.println();
        run();
    }
