...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 20 题 ======");
        System.out.println("题目：ArrayList 删除所有指定元素");
        System.out.println("说明：定义一个 ArrayList<String>，其中有多个相同字符串。");
        System.out.println();
        run();
    }
