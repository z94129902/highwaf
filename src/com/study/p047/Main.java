...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 47 题 ======");
        System.out.println("题目：HashMap 按 value 排序");
        System.out.println("说明：使用 HashMap<String, Integer> 保存姓名和成绩。");
        System.out.println();
        run();
    }
