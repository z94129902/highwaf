...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 51 题 ======");
        System.out.println("题目：ListIterator 双向遍历");
        System.out.println("说明：使用 LinkedList<String> 保存数据。");
        System.out.println();
        run();
    }
