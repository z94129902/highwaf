...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 45 题 ======");
        System.out.println("题目：HashMap 统计字符次数");
        System.out.println("说明：输入字符串，统计每个字符出现次数。");
        System.out.println();
        run();
    }
