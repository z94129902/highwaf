...
/**
 * 第 37 题：HashSet 和 ArrayList 去重对比
 *
 * 题目摘要：
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 37 题 ======");
        System.out.println("题目：HashSet 和 ArrayList 去重对比");
        System.out.println("说明：使用 ArrayList 保存重复数据，再用两种方式去重。");
        System.out.println();
        run();
    }
