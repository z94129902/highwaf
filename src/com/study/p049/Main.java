...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 49 题 ======");
        System.out.println("题目：Iterator 遍历集合");
        System.out.println("说明：使用 ArrayList<String> 保存多个名字。");
        System.out.println();
        run();
    }
