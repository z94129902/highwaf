...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 21 题 ======");
        System.out.println("题目：ArrayList 存储订单");
        System.out.println("说明：定义 Order 类，包含订单编号、用户名、金额。");
        System.out.println();
        run();
    }
