...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 75 题 ======");
        System.out.println("题目：泛型上限");
        System.out.println("说明：定义方法接收 List<? extends Number>。");
        System.out.println();
        run();
    }
    ...
    private static void run() throws Exception {
        ...
        box.setValue("泛型示例");
        System.out.println("Box 中的数据：" + box.getValue());
        // TODO 学员实现：练习泛型方法、泛型类、通配符上下限或泛型接口。
        solve();
    }
