...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("====== Java 高级练习 第 50 题 ======");
        System.out.println("题目：Iterator 安全删除元素");
        System.out.println("说明：使用 ArrayList<Integer> 保存 1 到 20。");
        System.out.println();
        run();
    }
    ...
    private static void run() throws Exception {
        ...
        while (iterator.hasNext()) {
            ...
            System.out.println("迭代到：" + name);
        }
        // TODO 学员实现：练习 Iterator 安全删除、ListIterator 双向遍历或自定义 Iterable。
        solve();
    }
